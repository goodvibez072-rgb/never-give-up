...
// Support STORAGE_PATH env var for VPS deployments.
// On VPS set: STORAGE_PATH=/var/www/amurscans/data/storage
const STORAGE_BASE_PATH = process.env.STORAGE_PATH || path.join(process.cwd(), 'data', 'storage');
